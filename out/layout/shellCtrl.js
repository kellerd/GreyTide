    ...
    (function (Controllers) {
        var ShellCtrl = (function () {
            ...
            ShellCtrl.prototype.activate = function () {
                var logger = this.common.logger.logSuccess;
                logger('Hot Towel Angular loaded!', null, ShellCtrl.controllerId, true);
                this.common.activateController([], this.controllerId);
            };
            ShellCtrl.prototype.registerEvents = function () {
                var _this = this;
                var events = this.config.events;
                this.$rootScope.$on('$routeChangeStart', function (event, next, current) { if (next.$$route.redirectTo != "/")
        ...
        app.controller(ShellCtrl.controllerId, ['$rootScope', 'common', 'config',
