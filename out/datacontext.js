...
(function (App) {
    ...
    (function (Services) {
        ...
        app.factory(Datacontext.serviceId, ['common', EntityManagerFactory.serviceId, 'config', function (common, entityManagerFactory, config) { return new Datacontext(common, entityManagerFactory, config); }]);
