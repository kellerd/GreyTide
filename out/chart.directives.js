...
(function (App) {
    ...
    (function (Directives) {
        ...
        app.directive(ChartBar.directiveId, ['config', 'common', function (c, cm) { return new ChartBar(c, cm); }]);
        app.directive(ChartLine.directiveId, ['config', 'common', function (c, cm) { return new ChartLine(c, cm); }]);
