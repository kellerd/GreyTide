    ...
    (function (Shared) {
        var Common = (function () {
            ...
            function Common($q, $rootScope, $timeout, commonConfig, logger) {
                var _this = this;
                this.queuePromise = function (key, callback, delay, immediate) {
                    if (!_this.queue[key]) {
                        _this.queue[key] = _this.$q.when();
                    }
                    _this.queue[key] = (_this.queue[key]).then(function () {
                        if (immediate) {
                            return callback();
                        }
                        else {
