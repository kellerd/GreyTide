...
(function (App) {
    var MetadataHelper = (function () {
        ...
        MetadataHelper.FillMetadataStore = function (store) {
            // Metadata-Helper instance configured with default namespace and key generator for this model
            var defaultNamespace = 'GreyTide.Models.V2';
            var helper = new breeze.config.MetadataHelper(defaultNamespace, breeze.AutoGeneratedKeyType.Identity);
            // DataTypes
            ...
            function addModel() {
                addType({
                    name: 'Model',
                    dataProperties: {
                        id: { type: GUID, required: true, isPartOfKey: true },
            ...
            function addStateCollection() {
                addType({
                    ...
                    dataProperties: {
                        ...
                        name: { type: STRING, required: true },
                        type: { type: STRING },
                        events: { complexTypeName: 'State', required: true, isScalar: false }
                    }
                });
            }
            ;
    ...
    App.MetadataHelper = MetadataHelper;
})(App || (App = {}));
